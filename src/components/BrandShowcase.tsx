                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="p-2.5 rounded-lg bg-orange-50 border-l-3 border-orange-600 border border-orange-200 mb-4">
                    ...
                    <p className="text-[11px] text-orange-900 mt-0.5 leading-snug">
                      {lang === 'kn'
                        ? 'ಪ್ರತಿ ತಿಂಗಳು ಗ್ಯಾಸ್ ದರ ಬದಲಾಗುವುದರಿಂದ ಇಂದಿನ ರಿಯಾಯಿತಿ ದರಕ್ಕಾಗಿ ಕರೆ ಅಥವಾ ವಾಟ್ಸಾಪ್ ಮಾಡಿ.'
                        : "Rate revisions occur monthly. Click below to call or WhatsApp for today's discounted rate."}
                    </p>
                  </div>
